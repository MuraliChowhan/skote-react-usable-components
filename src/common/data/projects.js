const projects = [
  {
    ...
    files: [
      { name: "EazyRooms Landing.Zip", size: "3.25 MB", link: "#" },
      { name: "EazyRooms Admin.Zip", size: "3.15 MB", link: "#" },
      { name: "EazyRooms Logo.Zip", size: "2.02 MB", link: "#" },
