        ...
        <SimpleBar style={{ height: "900px" }}>
          <div data-simplebar className="h-100">
            ...
            <div className="p-4">
              ...
              <div className="mb-2">
                <Link
                  to="//eazyrooms-v-light.react.themesbrand.com"
                  target="_blank"
                >
                  <img
                    src={layout4}
              ...
              <div className="mb-2">
                <Link
                  to="//eazyrooms-v-dark.react.themesbrand.com"
                  target="_blank"
                >
                  <img
                    src={layout5}
              ...
              <div className="mb-2">
                <Link
                  to="//eazyrooms-v-rtl.react.themesbrand.com"
                  target="_blank"
                >
                  <img
                    src={layout6}
              ...
              <Link
                to="//1.envato.market/eazyroomsreact"
