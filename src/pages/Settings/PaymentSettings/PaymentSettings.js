...
class PaymentSettings extends Component {
    ...
    render() {
        return (
            <React.Fragment>
                <h4 className="border-bottom pb-2 border-2">Payment Settings</h4>
                <Row>
                    <Col xl={12}>
                        <Card>
                            <CardBody>
                                ...
                                <Nav tabs className="nav-tabs-custom ">
                                    <NavItem>
                                        ...
                                        >
                                            ...
                                            <span className="d-none d-sm-block">Razorpay</span>
                                        </NavLink>
                                    </NavItem>
                                    <NavItem>
                                        <NavLink
                                        ...
                                        >
                                            ...
                                            <span className="d-none d-sm-block">Stripe</span>
                                        </NavLink>
                                    </NavItem>
                                    <NavItem>
                                        <NavLink
                                    ...
                                    <NavItem>
                                        ...
                                        >
                                            ...
                                            <span className="d-none d-sm-block">Authorize</span>
                                        </NavLink>
                                    </NavItem>
                                </Nav>
