                    ...
                    <div className="">
                      ...
                      <div className="chat-leftsidebar-nav">
                        <Nav pills justified>
                          <NavItem>
                            ...
                            >
                              ...
                              <span className="d-none d-sm-block">Waiting</span>
                            </NavLink>
                          </NavItem>
                          <NavItem>
                            <NavLink
                            ...
                            >
                              ...
                              <span className="d-none d-sm-block">Runnig</span>
                            </NavLink>
                          </NavItem>
                          <NavItem>
                            <NavLink
                        ...
                        >
                          ...
                          <TabPane tabId="4">
                            <h5 className="font-size-14 mb-3">Closed</h5>
                            <ul className="list-unstyled chat-list ng-star-inserted">
                              <li>
                                <div className="media align-items-center">
                                  ...
                                  <div className="media-body">
                                    <span className="font-size-14 mb-0">General</span>
                                  </div>
                                </div>
                              </li>
                            </ul>
